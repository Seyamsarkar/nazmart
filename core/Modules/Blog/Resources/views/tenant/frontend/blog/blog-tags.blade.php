                                ...
                                <div class="single-shops">
                                    <form action="{{URL::current()}}" method="GET" id="sorting-form">
                                        ...
                                        <div class="shop-nice-select" id="nice-select">
                                            <select>
                                                <option value="1" {{$order_type == 1 ? 'selected' : ''}}> {{__('Short By Name')}} </option>
                                                <option value="2" {{$order_type == 2 ? 'selected' : ''}}> {{__('Short By Ascending')}} </option>
                                                <option value="3" {{$order_type == 3 ? 'selected' : ''}}> {{__('Short By Descending')}} </option>
                                            </select>
                                        </div>
                                    </form>
