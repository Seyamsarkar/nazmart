                                ...
                                @foreach($all_subscriber as $data)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($data->verified <1)
                                                <form class="mb-3 mr-1" style="display: inline;float: left;margin-right: 7px" action="{{route('admin.newsletter.verify.mail.send')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
