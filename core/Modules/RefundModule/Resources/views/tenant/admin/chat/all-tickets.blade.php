                ...
                <div class="card">
                    <div class="card-body">
                        <div class="top-wrapp d-flex justify-content-between">
                            <div class="left-part">
                                <h4 class="header-title">{{__('All Message')}}</h4>
                            ...
                            <table class="table table-default table-striped table-bordered">
                                ...
                                @foreach($all_tickets as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <x-delete-popover permissions="support-ticket-delete" :url="route(route_prefix().'admin.refund.chat.delete',$data->id)"/>
                                            <x-view-icon :url="route(route_prefix().'admin.refund.chat.view',$data->id)"/>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
         ...
         $(document).ready(function(){
            $(document).on('click','.change_priority',function (e){
               ...
               //ajax call
                $.ajax({
                    'type': 'post',
                    'url' : "{{route('tenant.admin.refund.chat.priority.change')}}",
                    'data' : {
                        _token : "{{csrf_token()}}",
                        priority : priority,
                        id : id,
