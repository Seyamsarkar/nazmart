                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title mb-4">{{__("New Ticket")}}</h4>
                            <a href="{{route('tenant.admin.support.ticket.all')}}" class="btn btn-primary">{{__('All Support Tickets')}}</a>
                        </div>

                        <form action="{{route('tenant.admin.support.ticket.new')}}" method="POST" enctype="multipart/form-data">
                            @csrf
