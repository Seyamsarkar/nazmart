...
Route::group(['prefix' => 'admin-home/wallet','as'=>'landlord.admin.wallet.', 'middleware' => ['adminglobalVariable','auth:admin']], function () {
...
//buyer routes
Route::group(['as'=>'landlord.user.','prefix'=>'landlord', 'middleware'=> ['landlord_glvar','maintenance_mode']],function(){
