...
class BetterWorkOne extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/common/better-work-01.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $repeater_data = $this->setting_item('better_work_one_repeater');
        ...
        return self::renderView('tenant.common.better-work-one',$data);
