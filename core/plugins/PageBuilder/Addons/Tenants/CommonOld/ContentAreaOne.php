...
class ContentAreaOne extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/common/content-area-01.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $repeater_data = $this->setting_item('content_area_one_repeater');
        ...
        return self::renderView('tenant.common.content-area-one',$data);
