...
class KeyFeatureStyleSix extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/common/key-feature-06.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $repeater_data = $this->setting_item('key_feature_six');
        ...
        return self::renderView('tenant.common.key-feature-six',$data);
