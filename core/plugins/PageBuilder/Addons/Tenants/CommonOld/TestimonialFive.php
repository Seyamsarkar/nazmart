...
class TestimonialFive extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/common/testimonial-05.png';
    }
    ...
    public function admin_render()
    {
        ...
        foreach ($all_languages as $key => $lang) {
            ...
            $output .= Text::get([
                'name' => 'title_subtitle_'.$lang->slug,
                'label' => __('Subtitle'),
                'value' => $widget_saved_values['title_subtitle_'.$lang->slug] ?? null,
            ]);
    ...
    public function frontend_render()
    {
        ...
        $subtitle = $this->setting_item('title_subtitle_'.$current_lang) ?? '';
        ...
        return self::renderView('tenant.common.testimonial-five',$data);
