...
class TestimonialSix extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/common/testimonial-06.png';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.common.testimonial-six',$data);
