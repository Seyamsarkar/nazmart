...
class HeaderFive extends PageBuilderBase
{
    ...
    {
       return 'Tenant/Home/header-05.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $shape_image_one = $this->setting_item('shape_image_one') ?? '';
        $shape_image_two = $this->setting_item('shape_image_two') ?? '';
        ...
        $data = [
                 ...
                 'shape_image_one'=>$shape_image_one,
                 'shape_image_two'=>$shape_image_two,
                 'bg_image'=>$bg_image,
                 'padding_top'=>$padding_top,
                 'padding_bottom'=>$padding_bottom
            ];

        return self::renderView('tenant.header.header-five',$data);
