                            ...
                            <div class="single-blog-two-contents mt-3">
                                ...
                                <div class="single-blog-two-contents-tags mt-3">
                                        <span class="single-blog-two-contents-tags-item">
                                            <a href="{{route('tenant.frontend.blog.category', $item->category?->slug)}}"> <i class="las la-tag"></i> {{$item->category?->title}} </a>
                                        </span>
                                    <span class="single-blog-two-contents-tags-item"> <a href="{{route('tenant.frontend.blog.single',$item->slug)}}">  {{count($item->comments) ?? 0}} {{__('Comments')}} </a> </span>
                                </div>
                            </div>
                        </div>
                    </div>
