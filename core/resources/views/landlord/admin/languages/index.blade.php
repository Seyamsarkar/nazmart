    ...
    <div class="col-lg-12 col-ml-12">
        <div class="row g-4">
            ...
            <div class="col-lg-7">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-4">{{__('All Languages')}}</h4>
                            ...
                            @foreach($all_lang as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                        <x-change-default-lang :url="route(route_prefix().'admin.languages.default',$data->id)"/>
                                        @endif
                                         @endcan
                                    </td>
                                    <td>
                                        ...
                                        @if($data->default != 1)
                                            ...
                                            <x-delete-popover :url="route(route_prefix().'admin.languages.delete',$data->id)"/>
                                        @endif
                                        @endcan
                                     ...
                                     @can('language-edit')
                                        ...
                                        <a href="#"
                                           ...
                                           class="btn btn-success btn-xs mb-3 mr-1 lang_clone_btn"
                                           data-id="{{$data->id}}"
                                        >
    ...
    <div class="modal fade" id="language_item_clone_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route(route_prefix().'admin.languages.clone')}}" id="contact_info_edit_modal_form" method="post">
                    <div class="modal-body">
                        @csrf
