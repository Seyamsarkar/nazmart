                    ...
                    <div class="card-body">
                        <div class="header-wrapper d-flex justify-content-between">
                            ...
                            <div class="btn-wrapper">
                                <a href="{{route('landlord.admin.menu')}}" class="btn btn-primary btn-xs">{{__('All Menus')}}</a>
                            </div>
                        </div>
                        <form action="{{route('landlord.admin.menu.update',$page_post->id)}}" id="menu_update_form" method="post"
