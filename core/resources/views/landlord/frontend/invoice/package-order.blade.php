    ...
    <div class="cart-table-wrapper cart-wrapper">
        ...
        <div class="package-info-wrap">
            @if(!empty($payment_details))
                ...
                <ul>
                    <li><strong>{{__('Order ID')}}</strong> #{{$payment_details->package_id ?? ''}}</li>
                    ...
                    <li><strong>{{__('Package Price')}}</strong> {{amount_with_currency_symbol($payment_details->package_price ?? '')}}</li>
                    <li><strong>{{__('Package Description')}}</strong> {{$payment_details->package_id ?? ''}}</li>
                </ul>
            @endif
        </div>
    </div>
