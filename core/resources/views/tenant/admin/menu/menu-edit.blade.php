...
@section('style')
    <link rel="stylesheet" href="{{global_asset('assets/common/css/nestable.css')}}">
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrapper d-flex justify-content-between">
                            <h4 class="header-title mb-4">{{__('Edit Menu')}}</h4>
                            <div class="btn-wrapper">
                                <a href="{{route('tenant.admin.menu')}}" class="btn btn-primary btn-xs">{{__('All Menus')}}</a>
                            </div>
                        </div>
                        <form action="{{route('tenant.admin.menu.update',$page_post->id)}}" id="menu_update_form" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="menu-left-side-content">
                                        <h3 class="title mb-4">{{__('Add menu items')}}</h3>
                                   ...
                                   <div class="menu-structure-wrapper">
                                       <div class="card">
                                           <div class="card-header">
                                               <h3 class="title mb-4">{{__('Menu Structure')}}</h3>
                                           </div>
...
@section('scripts')
    <script src="{{global_asset('assets/common/js/jquery.nestable.js')}}"></script>
    <script>
