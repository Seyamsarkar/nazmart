    ...
    <div class="col-lg-12 col-ml-12">
        <div class="row g-4">
            ...
            <div class="col-lg-7">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-4">{{__('All Menus')}}</h4>
                            ...
                            <table class="table table-default">
                                ...
                                @foreach($all_menu as $data)
                                    <tr>
                                        ...
                                        <td>
                                                @if($data->status != 'default')
                                                      <x-delete-popover url="{{route('tenant.admin.menu.delete',$data->id)}}"/>
                                                @endif
            ...
            <div class="col-lg-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-4">{{__('Add New Menu')}}</h4>
                        <form action="{{route('tenant.admin.menu.new')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
