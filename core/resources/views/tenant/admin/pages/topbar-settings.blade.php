                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrapp d-flex justify-content-between">
                            <h4 class="header-title mb-4">{{__('Social Icons')}}  </h4>
                            <div class="header-title">
                                <button type="submit" class="btn btn-primary pr-4 pl-4 " data-bs-toggle="modal" data-bs-target="#add_social_icon">{{__('Add New')}}</button>
                            </div>
                        </div>
