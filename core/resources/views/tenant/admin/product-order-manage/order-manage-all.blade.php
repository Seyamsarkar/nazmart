                            ...
                            <table class="table table-default table-striped table-bordered">
                                ...
                                @foreach($all_orders as $data)
                                    <tr>
                                        ...
                                        <td class="text-capitalize">{{$data->checkout_type !== 'cod' ? $data->payment_gateway : 'Cash On Delivery'}}</td>
                                        <td>
                                            ...
                                            @else
                                                <span
                                                    class="alert alert-warning text-capitalize">{{$data->payment_status ?? __('Pending')}}</span>
                                            @endif
                                        </td>
                                        <td>
