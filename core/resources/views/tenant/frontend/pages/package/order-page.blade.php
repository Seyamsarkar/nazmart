...
@section('title')
    @php
          ...
          $title = $order_details->getTranslation('title',$user_lang)
    @endphp
        ...
        <div class="row reorder-xs justify-content-between">
            <div class="col-lg-8">
                ...
                <div class="order-content-area">
                    ...
                    @if(!empty(get_static_option('order_page_'.$user_select_lang_slug.'_form_title')))
                          <h2 class="text-center">{{get_static_option('order_page_'.$user_select_lang_slug.'_form_title') }} </h2>
                        @else
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="right-content-area">
                    @php
                        ...
                        $single_feat = $order_details->getTranslation('features',$user_lang);
                    @endphp

                    <div class="single-price-plan-02 wow animate__animated animate__fadeInUp">
                        <div class="price-header">
                            <h4 class="title">{{$order_details->getTranslation('title',$user_lang)}}</h4>
                        </div>
