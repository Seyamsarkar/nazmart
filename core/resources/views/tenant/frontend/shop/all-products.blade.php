    ...
    <section class="shop-area padding-top-100 padding-bottom-50">
        <div class="container-one">
            <div class="shop-contents-wrapper">
                @include('tenant.frontend.shop.partials.shop-search')

                @include('tenant.frontend.shop.partials.shop-sidebar-content')
                @include('tenant.frontend.shop.partials.shop-grid-products')
            </div>
        </div>
    </section>
    <!-- Shop area end -->
