                ...
                <div class="dashboard-address-details">
                    ...
                    <div class="single-dashboard-input">
                        <div class="single-info-input margin-top-30">
                            ...
                            <input class="form--control" type="text" name="name" placeholder="Type Your Name" value="{{$user_details->name}}">
                        </div>
                        <div class="single-info-input margin-top-30">
                            <label class="info-title"> {{__('Your Email')}}<span class="text-danger">*</span> </label>
                            <input class="form--control" type="email" name="email" placeholder="Type Your Email" value="{{$user_details->email}}">
                        </div>
                    </div>
                    <div class="single-dashboard-input">
                        <div class="single-info-input margin-top-30">
                            <label class="info-title"> {{__('Phone Number')}} </label>
                            <input class="form--control" type="text" name="phone" placeholder="Type Your Number" value="{{$user_details->mobile}}">
                        </div>

                        <div class="single-info-input margin-top-30">
                            <label class="info-title"> {{__('Company')}} </label>
                            <input class="form--control" type="text" name="company" placeholder="Type Your Number" value="{{$user_details->company}}">
                        </div>
                    </div>
                    <div class="single-dashboard-input">
                        <div class="single-info-input margin-top-30">
                            <label class="info-title"> {{__('Your City')}} </label>
                            <input class="form--control" type="text" placeholder="Type Your Area" name="city" value="{{$user_details->city}}">
                        </div>
                        <div class="single-info-input margin-top-30">
                            <label class="info-title"> {{__('Your State')}} </label>
                            <input class="form--control" type="text" placeholder="Type Your State" name="state" value="{{$user_details->state}}">
                        </div>
                        <div class="single-info-input margin-top-30">
