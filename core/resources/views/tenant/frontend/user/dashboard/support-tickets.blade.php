...
@section('section')
    <style>
        ...
        <a href="{{route('tenant.frontend.support.ticket')}}" class="btn btn-info margin-bottom-30">{{__('New Ticket')}}</a>
                ...
                <table class="table table-striped">
                    ...
                    @foreach($all_tickets as $data)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('tenant.user.dashboard.support.ticket.view',$data->id)}}"  class="btn btn-info text-white btn-xs" target="_blank">
