                ...
                <div class="col-md-8 col-lg-8">
                    <div class="sign-up register">
                        ...
                        <div class="form-wrapper">
                            <x-error-msg/>
                            <x-flash-msg/>
                            <form action="{{route('tenant.user.register.store')}}" method="post" enctype="multipart/form-data" class="contact-page-form style-01">
                                @csrf
                                <div class="row">
                            ...
                            <p class="info">{{__('Already have an Account?')}} <a href="{{route('tenant.user.login')}}" class="active">{{__('Sign in')}}</a>
                            </p>
                        </div>
                    </div>
                </div>
