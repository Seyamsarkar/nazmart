...
----------------------------------- */
Route::middleware(['landlord_glvar','maintenance_mode'])->controller(\App\Http\Controllers\Landlord\Frontend\LandlordFrontendController::class)->group(function (){
...
------------------------------ */
Route::controller(\App\Http\Controllers\Landlord\Admin\Auth\AdminLoginController::class)->prefix('admin')->group(function (){
...
Route::middleware(['landlord_glvar','maintenance_mode'])->controller(\App\Http\Controllers\Landlord\Frontend\LandlordFrontendController::class)->name('landlord.')->group(function () {
...
Route::controller(\App\Http\Controllers\Landlord\Frontend\UserDashboardController::class)->middleware(['landlord_glvar','maintenance_mode','tenantMailVerify'])->name('landlord.')->group(function(){
...
Route::controller(\App\Http\Controllers\Landlord\Frontend\SupportTicketController::class)->middleware('landlord_glvar')->name('landlord.')->group(function(){
